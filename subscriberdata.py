...
###  udr_json.py
###
###  This code simulates a UDR Service.
###########################################################


from udr_mongodb_insert import udr_mongodb_insert
...
def createSubscriber():
    ...
    if (content_type == 'application/json'):
        ...
        if (check_if_subscriber_exists(data['imsi']) == False):
           ...
           ## REPLACE ABOVE LINE WITH FUNCTION TO ADD 'DATA' INTO MONGODB
           ## THE 'DATA' HAS BE PASSED AS PARAMETER INTO PYMONGO_TEST_INSERT.PY
           udr_mongodb_insert(item)
           return (data)
        else:
